...
var index_2 = require('react-native-image-pan-zoom');
...
var ImageViewer = function (_React$Component) {
    ...
    (0, _createClass3.default)(ImageViewer, [{
        ...
        value: function getContent() {
            ...
            var ImageElements = this.props.imageUrls.map(function (image, index) {
                ...
                if (imageInfo.status === 'success' && _this6.props.enableImageZoom) {
                    return React.createElement(index_2.default, { key: index, style: _this6.styles.modalContainer, cropWidth: _this6.width, cropHeight: _this6.height, imageWidth: width, imageHeight: height, maxOverflow: _this6.props.maxOverflow, horizontalOuterRangeOffset: _this6.handleHorizontalOuterRangeOffset.bind(_this6), responderRelease: _this6.handleResponderRelease.bind(_this6), onLongPress: _this6.handleLongPress.bind(_this6, image), onClick: _this6.handleClick.bind(_this6), onDoubleClick: _this6.handleDoubleClick.bind(_this6) }, React.createElement(react_native_1.Image, { style: [_this6.styles.imageStyle, { width: width, height: height }], source: { uri: image.url } }));
                } else {
                    switch (imageInfo.status) {
                        case 'loading':
                            return React.createElement(react_native_1.TouchableHighlight, { key: index, onPress: _this6.handleClick.bind(_this6), style: _this6.styles.loadingTouchable }, React.createElement(react_native_1.View, { style: _this6.styles.loadingContainer }, _this6.props.loadingRender()));
                        case 'success':
                        ...
                        case 'fail':
                            return React.createElement(index_2.default, { key: index, style: _this6.styles.modalContainer, cropWidth: _this6.width, cropHeight: _this6.height, imageWidth: width, imageHeight: height, maxOverflow: _this6.props.maxOverflow, horizontalOuterRangeOffset: _this6.handleHorizontalOuterRangeOffset.bind(_this6), responderRelease: _this6.handleResponderRelease.bind(_this6), onLongPress: _this6.handleLongPress.bind(_this6, image), onClick: _this6.handleClick.bind(_this6), onDoubleClick: _this6.handleDoubleClick.bind(_this6) }, React.createElement(react_native_1.TouchableOpacity, { key: index, style: _this6.styles.failContainer }, React.createElement(react_native_1.Image, { source: _this6.props.failImageSource, style: _this6.styles.failImage })));
                    }
                }
            });
            return React.createElement(react_native_1.Animated.View, { style: [this.styles.container, { opacity: this.fadeAnim }] }, this.props.renderHeader(), React.createElement(react_native_1.View, { style: this.styles.arrowLeftContainer }, React.createElement(react_native_1.TouchableWithoutFeedback, { onPress: this.goBack.bind(this) }, React.createElement(react_native_1.View, null, this.props.renderArrowLeft()))), React.createElement(react_native_1.View, { style: this.styles.arrowRightContainer }, React.createElement(react_native_1.TouchableWithoutFeedback, { onPress: this.goNext.bind(this) }, React.createElement(react_native_1.View, null, this.props.renderArrowRight()))), React.createElement(react_native_1.Animated.View, { style: [this.styles.moveBox, { transform: [{ translateX: this.positionX }] }, { width: this.width * this.props.imageUrls.length }] }, ImageElements), this.props.imageUrls.length > 1 && this.props.renderIndicator(this.state.currentShowIndex + 1, this.props.imageUrls.length), this.props.imageUrls[this.state.currentShowIndex].originSizeKb && this.props.imageUrls[this.state.currentShowIndex].originUrl && React.createElement(react_native_1.View, { style: this.styles.watchOrigin }, React.createElement(react_native_1.TouchableOpacity, { style: this.styles.watchOriginTouchable }, React.createElement(react_native_1.Text, { style: this.styles.watchOriginText }, "查看原图(2M)"))), this.props.renderFooter());
        }
    }, {
        key: "saveToLocal",
        ...
        value: function render() {
            ...
            return React.createElement(react_native_1.View, __assign({ onLayout: this.handleLayout.bind(this), style: [{ flex: 1, overflow: 'hidden' }, this.props.style] }, this.props.others), childs);
        }
    }]);
    return ImageViewer;
}(React.Component);
ImageViewer.defaultProps = new typings.Props();
ImageViewer = __decorate([index_1.TransmitTransparently('style')], ImageViewer);
